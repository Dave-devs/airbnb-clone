...
export default function Profile() {
  ...
  const [email, setEmail] = useState<string | null>(user!.emailAddresses[0].emailAddress);
      ...
      {user && (
        <View style={styles.card}>
          ...
          <View style={{ flexDirection: 'row', gap: 6 }}>
            {/* If EDIT is not true show... */}
            {!edit && (
              <View style={styles.editRow}>
                <Text style={{ fontFamily: 'outfitSB', fontSize: 22 }}>
                  {firstName} {lastName}
                </Text>
            ...
            {edit && (
              <View style={styles.editRow}>
                <TextInput
                  ...
                  style={[defaultStyles.inputField, { width: '100%', flex: 1 }]}
                />
                <TextInput
